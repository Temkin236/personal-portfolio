    ...
    <div className="py-32 sm:py-56 lg:py-64 bg-gradient-to-b from-neutral-50 via-white/30 to-neutral-50 relative overflow-hidden">
      ...
      <div className="relative z-10">
        <div className="px-6 lg:px-24 xl:px-32 max-w-[1600px] mx-auto">
          <header className="mb-32 lg:mb-40 space-y-8 lg:space-y-10">
            <div className="flex items-center gap-6">
              <div className="w-16 h-[2px] bg-gradient-to-r from-black to-neutral-300" />
              <h4 className="text-[10px] font-black uppercase tracking-[0.5em] text-black">Verified Credentials</h4>
            </div>
            <h2 className="text-6xl sm:text-7xl lg:text-[10rem] font-heading font-bold text-black tracking-tighter leading-[0.85]">
              Verified <br /><span className="bg-gradient-to-r from-neutral-200 via-neutral-300 to-neutral-200 bg-clip-text text-transparent">Milestones.</span>
            </h2>
            <div className="flex items-center gap-3 pt-4">
              <div className="w-3 h-3 bg-green-500 rounded-full animate-pulse" />
              <span className="text-[11px] font-bold uppercase tracking-wider text-green-600">{certs.length} Professional Certifications Verified</span>
            </div>
          </header>
          ...
          <div className="flex justify-between items-center mb-16 lg:mb-20">
            <div className="flex items-center gap-6 bg-white/80 backdrop-blur-md px-8 py-4 rounded-full border border-neutral-200 shadow-lg">
              <span className="text-[10px] font-black uppercase tracking-[0.4em] text-neutral-400">{certs.length} Verified Achievements</span>
            </div>
